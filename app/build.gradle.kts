...
android {
    ...
    defaultConfig {
        ...
        minSdk = 30
        targetSdk = 36
        versionCode = providers.environmentVariable("LOCALANT_VERSION_CODE").orNull?.toIntOrNull() ?: 8
        versionName = providers.environmentVariable("LOCALANT_VERSION_NAME").orNull ?: "0.1.7"
